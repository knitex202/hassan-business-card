...
import "./Card.css";
import profilePic from "../Assets/received_231518876607829.jpg";
  ...
  return (
    <div className="card-container">
      ...
      <div className="button-container">
        <a href="tel:+17373147528">
          <button className="btn call-btn">Call</button>
        </a>
        <a href="mailto:knitex303@gmail.com">
          <button className="btn email-btn">Email</button>
        </a>
        <a
          href="https://www.linkedin.com/in/hassan-wilson-55774323b/"
          target="blank">
          <button className="btn linkedin-btn">Linked{linkedin}</button>
        </a>
      </div>
      <div className="article-container">
        <h3>About</h3>
        <h4>
          I am a Frontend Developer based out of the Greater Austin area in
          Texas
        </h4>
        <p>
          I am 33 years old and love creating innovative, solid and scalable
          frontend products that live on the internet.
        </p>
      </div>
